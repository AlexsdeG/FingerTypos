...
export const QWERTY_LAYOUT: KeyMap[] = [
  // Row 1 (Numbers)
  ...
  { code: 'Minus', char: '-', finger: 'pinky-right', row: 1, hand: 'right' },
  ...
  { code: 'KeyY', char: 'y', finger: 'index-right', row: 2, hand: 'right' },
  ...
  { code: 'BracketLeft', char: '[', finger: 'pinky-right', row: 2, hand: 'right' },
  { code: 'BracketRight', char: ']', finger: 'pinky-right', row: 2, hand: 'right' },
  { code: 'Backslash', char: '\\', width: 1.5, finger: 'pinky-right', row: 2, hand: 'right' },
  ...
  { code: 'Semicolon', char: ';', finger: 'pinky-right', row: 3, hand: 'right' },
  { code: 'Quote', char: "'", finger: 'pinky-right', row: 3, hand: 'right' },
  ...
  { code: 'KeyZ', char: 'z', finger: 'pinky-left', row: 4, hand: 'left' },
  ...
  { code: 'ShiftRight', char: 'Shift', width: 2.75, row: 4, hand: 'right', style: 'special' },

  // Row 5 (Space)
  { code: 'ControlLeft', char: 'Ctrl', width: 1.5, row: 5, hand: 'left', style: 'special' },
  ...
  { code: 'AltRight', char: 'Alt', width: 1.25, row: 5, hand: 'right', style: 'special' },
  ...
  { code: 'ControlRight', char: 'Ctrl', width: 1.5, row: 5, hand: 'right', style: 'special' },
];